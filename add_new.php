...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `user`(`id`, `first_name`, `last_name`, `date_birth`, `gender`, `job`, `email`) VALUES (NULL,'$first_name','$last_name','$date_birth','$gender','$job','$email')";
            ...
            <form action="" method="post" style="width:50vw; min-width:300px;">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="first_name" placeholder="Elon">
                    </div>

                    <div class="col">
                        <label class="form-label">Last Name:</label>
                        <input type="text" class="form-control" name="last_name" placeholder="Musk">
                    </div>
                </div>
